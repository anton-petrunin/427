...
\noi %\sout
{9.} Let $ABC$ be a nondegenerate triangele and $A'\in (BC)$, $B'\in (CA)$, $C'\z\in (AB)$ be the points such that 
...
\noi %\sout
{15.} Give a ruler-and-compass construction of an inscribed quadrilateral with given sides.
