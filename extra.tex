...
\noi 1. Describe all isometries of the Manhattan plane.

\ 

\noi 2. Construct a metric space $\mathcal X$ and a distance preserving map $f\:\mathcal X\to \mathcal X$ which is not an isometry.
